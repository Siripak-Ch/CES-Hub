...
(function () {
  ...
  function getConfiguredGasCandidates_() {
    ...
    // The deployed config is canonical after an Apps Script migration. Keep a
    // previously persisted override only as a final fallback so an old /exec
    // URL cannot shadow the current production deployment indefinitely.
