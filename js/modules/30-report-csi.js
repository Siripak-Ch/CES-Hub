...
function applyReportFilters() {
  ...
  // Standard team segmented control: selected = CES dark blue, others = neutral gray.
  ['All','MED','LAB','EHS'].forEach(function(t) {
    const btn = document.getElementById('btn-rteam-' + t);
    if (!btn) return;
    btn.className = 'ces-segmented-btn' + (rFilters.team === t ? ' active' : '');
    btn.style.cssText = '';
  });
  updateReportUI();
}
