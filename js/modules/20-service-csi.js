...
function renderServiceMemoMappingV55_(){if(!serviceMemoMappingPopupOpenV55)return;const options={title:'<div class="text-left text-[#003DA5] font-black"><i class="fas fa-code-compare mr-2"></i>Memo / Work Order ↔ Service CSI 2026</div>',html:svcMapV55PopupHtml_(),width:'min(1920px,99vw)',showConfirmButton:false,showCloseButton:true,customClass:{popup:'rounded-[1.75rem] ces-service-memo-popup-v264'},didClose:()=>{serviceMemoMappingPopupOpenV55=false;}};if(Swal.isVisible()&&document.querySelector('.swal2-popup'))Swal.update(options);else Swal.fire(options);}
async function openServiceMemoMapping(){if(!serviceMemoMappingLoadedV55)svcMapV55CacheLoad_();serviceMemoMappingPopupOpenV55=true;renderServiceMemoMappingV55_();if(serviceMemoMappingLoadedV55&&serviceMemoMappingRowsV55.length)return serviceMemoMappingRowsV55;return svcMapV55RestoreSaved_(true);}
