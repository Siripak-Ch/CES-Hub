...
(function () {
  ...
  var CACHE_KEY = 'CES_AI_LOCAL_KB_CACHE_';
  var EVAL_QUEUE_KEY = 'CES_AI_EVAL_QUEUE_';
  var EVAL_PENDING_KEY = 'CES_AI_EVAL_PENDING_';
  var HISTORY_KEY_PREFIX = 'CES_AI_LOCAL_HISTORY_';
  var state = {
    ready:false,
    loading:false,
    knowledge:[],
