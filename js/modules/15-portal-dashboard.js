...
var PORTAL_LINKS_CACHE_KEY_V203='CES_HOME_LINKS_CACHE_V214';
...
function meta(tab){var m={management_overview:['Management Overview','fa-chart-line'],yearly:['Job Dashboard','fa-chart-pie'],revenue:['Revenue Dashboard','fa-hand-holding-dollar'],ot:['OT Dashboard','fa-clock'],service:['Service CSI','fa-clipboard-check'],report:['Report CSI','fa-chart-bar'],calendar:['Master Calendar','fa-calendar-days'],checkin:['Check-in','fa-location-dot'],car_booking:['Car Booking','fa-car-side'],van_booking:['Van Booking','fa-van-shuttle'],weekly:['Weekly Report','fa-calendar-check'],kpi:['KPI Tracking','fa-chart-line'],report_manage:['Report Management','fa-file-invoice-dollar'],stock_dashboard:['Infusion Pump Dashboard','fa-chart-pie'],inventory:['Inventory','fa-boxes-stacked'],check_stock:['Check Stock','fa-qrcode'],team_information:['Team Information','fa-address-book'],team_plan:['Team Plan','fa-calendar-days'],monthly_report:['Monthly Report','fa-file-circle-check'],users:['User Management','fa-users-gear'],ces_evaluation:['CES Hub Evaluation','fa-star-half-stroke'],ces_ai_knowledge:['CES AI Knowledge','fa-robot'],health:['System Health','fa-heart-pulse'],setting:['Setting','fa-gears']};return m[tab]||[String(tab||'Module').replace(/_/g,' '),'fa-cube'];}
