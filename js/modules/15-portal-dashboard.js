...
window.CES_refreshPortalLinksAfterSettingSave=async function(){try{localStorage.removeItem(PORTAL_LINKS_CACHE_KEY_V203);localStorage.removeItem('CES_HOME_LINKS_CACHE_V3012');localStorage.removeItem(portalCacheKeyV19());}catch(ignore){}state.portalLinks=null;state.loaded=false;state.firstReady=false;return loadPortalLinksV20(true).then(function(result){renderPortalLinksV20(result);return result;});};
