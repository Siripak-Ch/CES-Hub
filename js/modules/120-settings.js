...
// --- Setting Module Logic ---
    ...
    async function saveSettingSectionV264(section, button) {
        ...
        const all = collectFullSystemConfig_(), patch = {CONFIG_SCHEMA_VERSION:'30.0.34'};
